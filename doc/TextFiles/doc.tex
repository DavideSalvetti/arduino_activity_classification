...
\begin{itemize}
	...
	\todo{questa riga va tolta oppure meglio spiegare perchè non è stata inserita nella classificazione?}
\end{itemize}
...
Per poter acquisire i dati con Arduino, è stato necessario sviluppare un firmware apposito che consentisse di eseguire le acquisizioni utilizzando la tecnologia Bluetooth Low Energy (BLE), in cui è stato utilizzato Arduino come \textit{Peripherical}, che trasmette i dati sotto forma di caratteristiche, e l'applicazione come \textit{Central}, che li riceve. \todo{dubbio: i due ruoli vanno invertiti?}

I dati acquisiti con il BLE, come preannunciato nella sezione precedente, sono: le accelerazioni e le velocità di rotazione entrambe sui tre assi, la temperatura e l'umidità. \todo{impostare come sezione precedente}
...
\todo{errore: non riconosce comando SI}
...
\end{figure}
\todo{mancano schermate cyclette e walking}
